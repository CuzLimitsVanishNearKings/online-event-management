...
export const SlidersHorizontal = ({ className }: { className?: string }) => (
  <svg 
    viewBox="0 0 24 24" 
    fill="none" 
    stroke="currentColor" 
...
export const Star = ({ className, fill = "none" }: { className?: string, fill?: string }) => (
  <svg 
    viewBox="0 0 24 24" 
    fill={fill}
    stroke="currentColor" 
...
export const Heart = ({ className, fill = "none" }: { className?: string, fill?: string }) => (
  <svg 
    viewBox="0 0 24 24" 
    fill={fill}
    stroke="currentColor" 
...
export const Palette = ({ className }: { className?: string }) => (
  ...
  >
    ...
    <path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10c.92 0 1.5-.7 1.5-1.5 0-.4-.15-.79-.44-1.1-.28-.31-.44-.71-.44-1.15 0-.91.74-1.65 1.65-1.65H15.5c3.03 0 5.5-2.47 5.5-5.5 0-4.96-4.04-9.04-9-9z" />
  </svg>
)
...
export const Theater = ({ className }: { className?: string }) => (
  <svg 
    viewBox="0 0 24 24" 
    fill="none" 
    stroke="currentColor" 
    ...
    className={className}
  >
    <path d="M2 10s2-3 5-3 8 3 8 3" />
    <path d="M22 10s-2-3-5-3-8 3-8 3" />
    <path d="M12 7V3" />
    <path d="M7 13h10" />
    <path d="M7 17h10" />
    <path d="M9 21h6" />
...
export const Building2 = ({ className }: { className?: string }) => (
  <svg 
    viewBox="0 0 24 24" 
    fill="none" 
    stroke="currentColor" 
